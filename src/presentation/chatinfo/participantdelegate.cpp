...
ParticipantDelegate::ParticipantDelegate(QObject *parent)
    : QStyledItemDelegate{parent}
{}

void ParticipantDelegate::paint(QPainter *painter,
...
QSize ParticipantDelegate::sizeHint(const QStyleOptionViewItem &,
