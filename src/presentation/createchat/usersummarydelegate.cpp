...
UserSummaryDelegate::UserSummaryDelegate(QObject *parent)
    : QStyledItemDelegate(parent)
{}


void UserSummaryDelegate::paint(QPainter *painter,
...
QSize UserSummaryDelegate::sizeHint(const QStyleOptionViewItem &,
